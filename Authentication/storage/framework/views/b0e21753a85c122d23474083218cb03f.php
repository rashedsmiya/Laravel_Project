...
<body>
    ...
    <div class="mx-auto mt-5 w-full max-w-xl bg-gray-200 rounded-lg shadow-lg p-6">
        <div>
            <h3 class="text-white text-lg font-semibold bg-blue-500 px-4 py-2 rounded-t-lg">Login</h3>
        </div>
        <div class="mt-4">
            ...
            <div class="mt-5 flex flex-col sm:flex-row gap-3">
                <button class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition"> Login </button>
...
</html><?php /**PATH C:\Users\user\Desktop\Laravel_Project\Authentication\resources\views/login.blade.php ENDPATH**/ ?>