...
<html lang="en">
  ...
  <link href="{{asset('/website/css/style.css')}}" rel="stylesheet"></head>
  <body
...
>
  <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
    <div class="vd to/4 tc wf yf">
      <a href="index.html">
        <img class="om" src="{{asset('/website/assets/images/logo-light.svg')}}" alt="Logo Light" />
        <img class="xc nm" src="{{asset('/website/assets/images/logo-dark.svg')}}" alt="Logo Dark" />
      </a>
    ...
    >
      <nav>
        <ul class="tc _o sf yo cg ep">
          ...
          <li><a href="index.html#support" class="xl {{isset($activePage) && $activePage === 'home') ? 'active' : ''}}">Support</a></li>
        </ul>
      </nav>
      ...
      <div class="tc wf ig pb no">
        <div class="pc h io pa ra" :class="navigationOpen ? '!-ud-visible' : 'd'">
          <label class="rc ab i">
            ...
            <!-- Icon Sun -->
            <img class="xc nm" src="{{asset('/website/assets/images/icon-moon.svg')}}" alt="Moon" />
          </label>
        </div>
